...
class localVarTabAttr extends attrInfo {
  ...
  class localVarEnt {
    ...
    localVarEnt( DataInputStream dStream, constPool constPoolSec ) {
      ...
      start_pc = localVarTabAttr.this.readU2( dStream );
      length = localVarTabAttr.this.readU2( dStream );
      name_index = localVarTabAttr.this.readU2( dStream );
      descriptor_index = localVarTabAttr.this.readU2( dStream );
      index = localVarTabAttr.this.readU2( dStream );
  ...
  localVarTabAttr( String name, int length,
    ...
    super( name, length );
    int numVarEnt = this.readU2( dStream );
